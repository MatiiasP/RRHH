...
class Candidato(models.Model):
    ...
    curriculum = models.FileField(upload_to='curriculums/', blank=True, null=True)  # Campo para el currículum
...
class Solicitud(models.Model):
    codigoEmpleado = models.ForeignKey(Empleado, on_delete=models.CASCADE)  # Verifica que el nombre del campo sea correcto
